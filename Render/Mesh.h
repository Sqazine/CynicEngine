...
namespace CynicEngine
{
    struct Vertex
    {
        ...
        static IGfxVertexDesc GetVertexDesc()
        {
            ...
            if (!isInit)
            {
                ...
                attrib.offset = offsetof(Vertex, texCoord);
                vertexDesc.attribs.emplace_back(attrib);
            }
            return vertexDesc;
        }
    ...
    public:
        ...
        const IGfxVertexBuffer<Vertex> *GetVertexBuffer() const { return mVertexBuffer.get(); }
    ...
    private:
        ...
        std::unique_ptr<IGfxVertexBuffer<Vertex>> mVertexBuffer;
