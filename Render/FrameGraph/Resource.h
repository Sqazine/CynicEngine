...
namespace CynicEngine
{
    ...
    public:
            ...
            : ResourceBase(name, nullptr), mDescription(description), mActualData(actualData)
        {
            ...
            if (!actualData)
                mActualData = CynicEngine::Realize<DescriptionType, ActualType>(mDescription);
        }
    ...
    protected:
        ...
        {
            if (IsTransient())
                std::get<std::unique_ptr<ActualType>>(mActualData) = CynicEngine::Realize<DescriptionType, ActualType>(mDescription);
        }
