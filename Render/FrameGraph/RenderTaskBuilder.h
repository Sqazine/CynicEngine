...
namespace CynicEngine
{
    ...
    {
    public:
        explicit RenderTaskBuilder(FrameGraph *frameGraph, RenderTaskBase *task)
        ...
        ResourceType *CreateResource(std::string_view name, const DescriptionType &description)
        {
